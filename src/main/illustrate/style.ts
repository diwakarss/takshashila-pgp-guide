...
Recurring character 'the analyst': a small deadpan stick figure drawn as a WHITE (unfilled) body with a clean thin black outline, small dot eyes, thin legs, serious not cute. The analyst PERFORMS the core idea, not decoration. IMPORTANT: ordinary people and the analyst are always WHITE-fill outline figures. Reserve a SOLID BLACK filled figure ONLY for a malicious or adversarial actor (a rule-breaker, bad actor, exploiter, or threat) when the concept genuinely needs one — otherwise every figure is white-fill outline.
